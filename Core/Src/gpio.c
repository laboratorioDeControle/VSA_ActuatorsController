...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3|GPIO_PIN_4|SEAL_CONTACT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB3 PB4 SEAL_CONTACT_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_4|SEAL_CONTACT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
